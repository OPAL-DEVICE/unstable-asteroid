...
## Problem ##
  > Sometimes people have trouble sharing ideas in groups. Having one recorder in a large group often does not allow that recorder to contribute.

## Solution ##
  > Anonymity allows people to share ideas freely. Providing an interface for users allows everybody to contribute freely.
